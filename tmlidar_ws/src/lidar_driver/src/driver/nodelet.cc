...
namespace lidar_driver
{
  ...
  private:
    ...
    boost::shared_ptr<lidarDriver> dvr_; ///< driver implementation class
  };

  void DriverNodelet::onInit()
  {
    // start the driver
    dvr_.reset(new lidarDriver(getNodeHandle(), getPrivateNodeHandle(), getName()));
...
// Register this plugin with pluginlib.  Names must match nodelet_lidar.xml.
//
// parameters are: class type, base class type
PLUGINLIB_EXPORT_CLASS(lidar_driver::DriverNodelet, nodelet::Nodelet)
