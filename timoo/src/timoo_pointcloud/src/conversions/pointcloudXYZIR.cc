...
PointcloudXYZIR::PointcloudXYZIR(
    ...
    : DataContainerBase(max_range, min_range, target_frame, fixed_frame, 0, 1,
                        true, scans_per_block, tf_ptr, 6, "x", 1,
...
void PointcloudXYZIR::setup(const timoo_msgs::timooScan::ConstPtr& scan_msg)
{
...
void PointcloudXYZIR::addPoint(float x, float y, float z, uint16_t ring,
